...
const Modal = () => {
  return (
    <div>
          ...
          <div className="modal_main">
            <form>
              ...
              <div className="modal_lang">
                ...
                <select name="modal_lang" id="modal_lang">
                  <option value="KR">한국어</option>
                  <option value="JP">日本語</option>
                  <option value="WW">English</option>
                </select>
              </div>
            </form>
          </div>
      ...
      <div className="modal_regi hidding">
        <div className="modal_wrapper">
          ...
          <div className="modal_main">
            <form>
              <div className="modal_input">
                <div>이메일</div>
                <input readonly className="modal_disabled" type="text" name="modal_email" placeholder="이메일을 입력해주세요." />
              </div>
              <div className="modal_input">
                <div>이름</div>
              ...
              <div className="modal_regi_agree_check">
                <div className="modal_agree_all">
                  <div>
                    <input type="checkbox" name="modal_agree_all" value="modal_agree_all" checked />
                    <p>전체동의</p>
                  </div>
                </div>
                <hr />
                <div className="modal_agree_age">
                  <div>
                    <input type="checkbox" name="modal_agree_age" value="modal_agree_age" checked />
                    <p>만 14세 이상입니다.(필수)</p>
                  </div>
                </div>
                <div className="modal_agree_oneid">
                  <div>
                    <input type="checkbox" name="modal_agree_oneid" value="modal_agree_oneid" checked />
                ...
                <div className="modal_agree_collect">
                  <div>
                    <input type="checkbox" name="modal_agree_collect" value="modal_agree_collect" checked />
